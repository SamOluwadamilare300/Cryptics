...
export default function Footer(){
    return (
        <footer className="bg-white py-2 dark:bg-transparent">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    ...
                    <Link href="#" className="text-body font-bold block hover:text-title">
                        <span className='font-bold '>Course</span>
                    </Link>
                    <Link href="#" className="text-body font-bold block hover:text-title">
                        <span className='font-bold '>Affiliate Stories</span>
                    </Link>
                    <Link href="#" className="text-body font-bold block hover:text-title">
                ...
                <span className="text-caption block text-center font-extrabold text-sm">Cryptics Academy. All rights reserved</span>
            </div>
        </footer>
    )
}